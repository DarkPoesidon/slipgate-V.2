...
type NaiveConfig struct {
	...
	DisableHideIP          bool   `json:"disable_hide_ip,omitempty"`
	DisableHideVia         bool   `json:"disable_hide_via,omitempty"`
	DisableProbeResistance bool   `json:"disable_probe_resistance,omitempty"`
}

func (n *NaiveConfig) ResolvedPort() int {
	if n == nil || n.Port == 0 {
		return 443
	}
	return n.Port
...
func (n *NaiveConfig) ResolvedLogLevel() string {
	if n == nil || strings.TrimSpace(n.LogLevel) == "" {
		return "WARN"
	}
	switch strings.ToUpper(strings.TrimSpace(n.LogLevel)) {
	case "DEBUG", "INFO", "WARN", "ERROR":
		return strings.ToUpper(strings.TrimSpace(n.LogLevel))
	default:
		return "WARN"
	}
}

func (n *NaiveConfig) HideIPEnabled() bool {
	return n == nil || !n.DisableHideIP
}

func (n *NaiveConfig) HideViaEnabled() bool {
	return n == nil || !n.DisableHideVia
}

func (n *NaiveConfig) ProbeResistanceEnabled() bool {
	return n == nil || !n.DisableProbeResistance
}
