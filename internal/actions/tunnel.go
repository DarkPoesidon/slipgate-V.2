...
func init() {
	Register(&Action{
		...
		Inputs: []InputField{
			...
			{Key: "naive-port", Label: "NaiveProxy listen port", DependsOn: "transport", DependsOnValues: []string{"naive"}},
			{Key: "naive-user", Label: "NaiveProxy auth username", CLIOnly: true},
			{Key: "naive-password", Label: "NaiveProxy auth password", CLIOnly: true},
			{Key: "naive-log-level", Label: "NaiveProxy Caddy log level", CLIOnly: true},
			{Key: "naive-hide-ip", Label: "Enable NaiveProxy hide_ip (yes/no)", CLIOnly: true},
			{Key: "naive-hide-via", Label: "Enable NaiveProxy hide_via (yes/no)", CLIOnly: true},
			{Key: "naive-probe-resistance", Label: "Enable NaiveProxy probe_resistance (yes/no)", CLIOnly: true},
	...
	Register(&Action{
		...
		Inputs: []InputField{
			...
			{Key: "naive-port", Label: "NaiveProxy listen port", CLIOnly: true},
			{Key: "naive-user", Label: "NaiveProxy auth username", CLIOnly: true},
			{Key: "naive-password", Label: "NaiveProxy auth password", CLIOnly: true},
			{Key: "naive-log-level", Label: "NaiveProxy Caddy log level", CLIOnly: true},
			{Key: "naive-hide-ip", Label: "Enable NaiveProxy hide_ip (yes/no)", CLIOnly: true},
